...
class SpectrogramPlugin extends BasePlugin {
    ...
    isRendering = false;
    lastZoomLevel = 0;
    renderThrottleMs = 50; // Reduced frequency for better performance
    zoomThreshold = 0.05; // More sensitive zoom detection
    drawnCanvases = {};
    pendingBitmaps = new Set();
    isScrollable = false;
    ...
    fastDownsample(oldMatrix, targetWidth, freqBins) {
    ...
    fillImageDataFast(data, segmentPixels, segmentWidth, bitmapHeight) {
